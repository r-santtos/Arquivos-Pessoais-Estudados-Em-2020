...
function Scheduling() {
  ...
  /** FUNCTION DELETE FINISHED CANCEL */
  function delFinishedCancel() {
    db.transaction(
      tx => {
          ...
          <View style={styles.card}>
            ...
            <View style={styles.btns}>
              <RectButton style={[styles.btn, styles.btnDel]} onPress={() => setCancel([
                ...
                <Text style={{color: '#fff', fontWeight: 'bold', textTransform: 'uppercase'}}>Cancelar</Text>
              </RectButton>
