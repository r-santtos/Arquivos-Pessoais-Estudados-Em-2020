    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          ...
          <TouchableHighlight style={styles.btnModal} onPress={() => ModalSelect('Food')}>
            <Text style={styles.txtWhite}>Food</Text>
          </TouchableHighlight>
          ...
          <TouchableHighlight style={styles.btnModal} onPress={() => ModalSelect('Vehicle Purchase')}>
            <Text style={styles.txtWhite}>Vehicle Purchase</Text>
          </TouchableHighlight>

          <TouchableHighlight style={styles.btnModal} onPress={() => ModalSelect('Real Estate Purchase')}>
            <Text style={styles.txtWhite}>Real Estate Purchase</Text>
          </TouchableHighlight>

          <TouchableHighlight style={styles.btnModal} onPress={() => ModalSelect('Vehicle Expenses')}>
            <Text style={styles.txtWhite}>Vehicle Expenses</Text>
          </TouchableHighlight>

          <TouchableHighlight style={styles.btnModal} onPress={() => ModalSelect('Property Expenses')}>
            <Text style={styles.txtWhite}>Property Expenses</Text>
          </TouchableHighlight>

          <TouchableHighlight style={styles.btnModal} onPress={() => ModalSelect('Education')}>
            <Text style={styles.txtWhite}>Education</Text>
          </TouchableHighlight>

          <TouchableHighlight style={styles.btnModal} onPress={() => ModalSelect('Impostos')}>
            <Text style={styles.txtWhite}>Impostos</Text>
          </TouchableHighlight>

          <TouchableHighlight style={styles.btnModal} onPress={() => ModalSelect('Taxes')}>
            <Text style={styles.txtWhite}>Taxes</Text>
          </TouchableHighlight>

          <TouchableHighlight style={styles.btnModal} onPress={() => ModalSelect('Recreation')}>
            <Text style={styles.txtWhite}>Recreation</Text>
          </TouchableHighlight>

          <TouchableHighlight style={styles.btnModal} onPress={() => ModalSelect('Alimony')}>
            <Text style={styles.txtWhite}>Alimony</Text>
          </TouchableHighlight>

          <TouchableHighlight style={styles.btnModal} onPress={() => ModalSelect('Health Expenses')}>
            <Text style={styles.txtWhite}>Health Expenses</Text>
          </TouchableHighlight>

          <TouchableHighlight style={styles.btnModal} onPress={() => ModalSelect('Transport')}>
            <Text style={styles.txtWhite}>Transport</Text>
          </TouchableHighlight>
      ...
      <View style={styles.btns}>
        <RectButton style={[styles.btn, styles.btnAtive]} onPress={Clear}>
          <Text style={styles.txtBlack}>Cancel</Text>
        </RectButton>

        <RectButton style={[styles.btn, styles.btnPassive]} onPress={() => btnSubmit('outgoing')}>
