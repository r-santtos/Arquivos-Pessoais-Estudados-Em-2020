...
function Report() {
  ...
  useEffect(() => {
    db.transaction(
      tx => {
        tx.executeSql("select * from tbfinished order by day desc limit 31", [], (_, { rows: { _array } }) => setResposta(_array));
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.title}>
        <Text style={styles.txtWhite}>Clientes Atendidos</Text>
      </View>
        ...
        renderItem={({ item }) => (
          <View style={styles.boxList}>
            ...
            <View style={styles.list}>
              ...
              <Text style={styles.txtWhite}>{item.client}</Text>
